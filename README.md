It includes a CLI-based platform (NextGenAcademicSolution.java, .class) where users can post and answer any type of questions, with data stored in doubts and answers files.
